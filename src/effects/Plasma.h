...
//   (intensity sin uso — el brillo se controla globalmente)
// ──────────────────────────────────────────────────────────────────────────────
...
public:
    ...
    void render() override {
        ...
        for (unsigned i = 0; i < numLeds; i++) {
            ...
            leds[i] = ColorFromPalette(PaletteManager::getPalette(_paletteIndex), colorIndex, stripLed.brightness, LINEARBLEND);
        }
